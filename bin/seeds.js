...
const articles = [
  {
    ...
    text:
      "Gorges du Verdon has the most beautiful cliffs in Europe. The area offers more than 1,500 routes on good limestone rock. Some of them are introductory paths, perfect to learn pitch climbing.",
    author: "Teddy Our, lead dev bud",
    image:
      "https://d3rrfy0o57uet0.cloudfront.net/wp-content/uploads/2017/11/Les-Gorges-du-Verdon-6.jpg"
  },
  {
    date: "July 3th, 2020",
    title: "Rock Climbing in Colorado",
    text:
      "Most of those places offer traditional climbing on granite cracks or unprotected slabs. There are a few exceptions, but if you want to find bolts for sport climbing on limestone, the closest place we know of is Shelf Road, south of Denver. Other sport climbing places include Lyons (from bad to fairly good) or Golden (good but crowded).",
    author: "Benjamin D, the US climber",
    image: "http://www.gdargaud.net/Climbing/Colorado/SecretSpot.jpg"
  },
  {
    date: "June 25th, 2020",
    title: "Dolomites, Italy",
    text:
      "Situated south of the Austrian/ Italian border lies the Dolomites. These towering slabs of limestone at times scrape the sky at 3000m and present one of the most varied climbing destinations in Europe. From scrambling, to single pitch, to extensive trad routes; there is something to excite every level of climber.This paired with the stunning scenery makes for a must visit climbing location.",
    author: "Olivier Burns, best firefighter",
    image:
      "https://www.ospreyeurope.com/wp-content/uploads/2018/07/Dolomites-Top-Climbing-Blog-Image.jpg"
  },
  {
    date: "June 4th, 2020",
    title: "South of Paris, in Fontainebleau",
    text:
    ...
    image:
      "https://www.climbing.com/.image/ar_16:9%2Cc_fill%2Ccs_srgb%2Cfl_progressive%2Cg_faces:center%2Cq_auto:good%2Cw_620/MTM4NDMzMjIyMDI2NTM2Mjg2/img_0216jpg.jpg"
  },

  {
    ...
    text:
      "The park is listed as a UNESCO world heritage site, there are granite cliffs over 1,000 m high, waterfalls among the largest in the world, giant sequoias several tens of meters high, you maybe even spot free roaming bears. Do not miss if you go to SF.",
    author: "Benjamin D, the US climber",
...

  {
    ...
    title: "Gentle rock climbing course around Die, in the Drôme",
    text:
      "This 3-day course is perfect to start climbing in natural site (block, cliff and Drôme river). It is particularly suitable for beginners or indoor climbers who wish to take their first step on the cliff. A progressive learning, adapted to each, will be done during these 3 days. The items are: alignment on a hold, breathing, placement and of course the techniques to be autonomous xhen leading. It is also a beautiful way to discover the beauty of the region of Die (Drôme) with the colors of autumn. In a beautiful cottage in the south Vercors. The meals cooked by Laurence with local and fresh products, will permit recovery and sharing.",
    author: "Teddy Our, lead dev bud",
    image:
      "https://images.unsplash.com/photo-1463567727315-4a5cc526b47c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80"
  },
  {
    ...
    author: "Olivier Burns, best firefighter",
    image:
      "https://images.unsplash.com/photo-1560539517-86e5c7fefb65?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1350&q=80"
  }
];
