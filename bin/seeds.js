...
const spots = [{
  ...
  },
  {
    ...
    latitude: 44.648761,
    longitude: 5.078759,
    image: "http://densite-escalade.fr/wp-content/uploads/2014/11/DSCF3853-300x168.jpg",
    description: "Petit parking à droite en allant vers la forêt de Saou. Au milieu des pins une petite colline surmontée d'une falaise calcaire. Sur cette falaise entre 50 et 100 voies du 3a au 7b. Courte marche d'approche bien raide. Orientation nord très appréciable en été !",
    comments: [],
    category: "3a, 7b"
  },
  {
  ...
  },
  {
    ...
    description: "Marche d'approche qui calme bien avec 30 minutes de raide montée. Mieux vaut prendre son temps et ne pas trop s'enflammer pour arriver en état de grimper sur le secteur. On y trouve un joli et original caillou très adhérent. Les voies sont bien équipées, on ne se fait pas trop peur et on peut se concentrer sur les difficultés. J'ai beaucoup aimé et ça m'a motivé pour aller acheter le topo en redescendant au village.",
    comments: [],
    category: "3a,7b"
  },
  {
    ...
    latitude: 44.625489,
    longitude: 5.017309,
    image: "https://oblyk.org/storage/photos/crags/200/la-borne-de-jeanne-5.jpg",
    description: "La borne de Jeanne est un site d'escalade de Voie de Calcaire, situé à Soyans dans le département Drôme, On y trouve 2 lignes allant de 6b à 7b",
    comments: [],
    category: "6b, 7b"
  },
  {
    ...
    description: "9 voies dans une minuscule baume au-dessus de la route Saoû -> Pont de Barret, 400 mètres après le Pont de Félines sur la droite. Nom des voies peints en rouge. Voies courtes et pêchues sur profil déversant.",
    comments: [],
    category: "5c, 7c"
  },
  {
    ...
    latitude: 44.627618,
    longitude: 5.02232,
    image: "https://media.camptocamp.org/c2corg_active/1559462967_1302800704MI.jpg",
    description: "Petit rocher école à 10 km d'Apt et a coté d'un petit cours d'eau 'le calavon' qui, en été, rafraichira les petits... et les grands.",
    comments: [],
    category: "4c, 7a"
  },
  {
    ...
    latitude: 36.552,
    longitude: 140.098,
    image: "https://cdn.cheapoguides.com/wp-content/uploads/sites/2/2013/09/IMG_2391.jpg",
    description: "Mount Tsukuba is a gorgeous double peaked mountain in the Ibaraki Prefecture. At only 877 meters tall, Tsukuba-san is a much easier, relaxing, and less crowded alternative to the ever popular Mt. Fuji. On a clear day, you can see a panoramic view of the entire Kanto plain, the skyline of Tokyo, and Mt. Fuji. On a cloudy day, you can still get a pretty killer view of the surrounding nature.",
    comments: [],
    category: ""
  },
  {
  ...
  },
  {
    ...
    latitude: -32.14524,
    longitude: 19.033785,
    image: "https://d1vs4ggwgd7mlq.cloudfront.net/wp-content/uploads/2018/07/woods-finnish-line-photo-brooke-raboutou.jpg",
    description: "It's very rare in the world to find something that's the most striking line in the area, and it's actually one of the hardest too.",
    comments: [],
    category: "5c, 8a"
  },
  {
    ...
    latitude: -23.0903,
    longitude: 45.1903,
    image: "https://photo980x880.mnstatic.com/53e1c76f079a6e5309eafbcf37df4551/ubatuba-praia-da-fortaleza.jpg",
    description: "Curta sobre a pratica de boulder, uma modalidade da escalada em Ubatuba na praia de Fortaleza. Com escaladores como Janine Cardoso, Flavio Massa, Lucas Rocha...",
    comments: [],
    category: "6b, 7b"
  },
  {
  ...
  },
  {
    ...
    latitude: 55.05,
    longitude: -8.45,
    image: "https://uniqueascent.ie/uploadedfiles/articles/donegal-rock-climbing-2019/WAW-Wall-Owey.jpeg",
    description: "An Sho, another outstanding year on the coast, out on the uninhabited islands and in the hills of Donegal with Cruit and Owey Islands having a steady stream of climbing visitors from March to November. ",
    comments: [],
    category: "2b, 6c"
  },
  {
    ...
    latitude: 48.404676,
    longitude: 2.70162,
    image: "https://image.thecrag.com/0x199:639x412/fit-in/639x213/5a/80/5a80978cef307e6ddb9101d9b2ab578ace4ad453",
    description: "Fontainebleau is the most popular bouldering destination in the world and a must visit place for every climber. Situated about 70 km South-East from Paris the climbing area consists of multiple different sectors located around the Fontainebleau village.",
    comments: [],
    category: "2b, 8c"
  }
];
...
const articles = [{
  ...
  {
    date: "Mai 12, 2020",
    title: "Yosemite National Park, in San Francisco",
    text: "The park is listed as a UNESCO world heritage site, there are granite cliffs over 1,000 m high, waterfalls among the largest in the world, giant sequoias several tens of meters high, you maybe even spot free roaming bears. Do not miss if you go to SF.",
    author: "Benjamin D, the US climber",
    image: "https://www.roadtrippin.fr/image/spot/3x2-800/yosemite.jpg"
  },
  {
